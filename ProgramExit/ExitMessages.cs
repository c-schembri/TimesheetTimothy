...
#endif // RELEASE
        { ExitCode.InvalidArgumentCount,     _ => "Timothy requires two arguments, command and target user (e.g., 'commit' and 'user@email.com')" },
        { ExitCode.InvalidArgumentSpecified, arg => $"'{arg}' is an unrecognised command" },
        { ExitCode.LoginDetailsIncorrect,    _ => "Entered username or password is incorrect" },
        { ExitCode.JobsFileNotFound,         _ => "Could not find 'jobs.json' file" },
